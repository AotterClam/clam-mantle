...
|---|---|
| [`install`](install/SKILL.md) | User wants to start a new mantle project (empty repo / "I want a blog" / "headless CMS for my Next.js"). Picks `starters/blog` vs `starters/blank`. |
