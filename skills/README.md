...
|---|---|
| [`install`](install/SKILL.md) | User wants to start a new mantle project (empty repo / "I want a publication site" / "headless CMS for my Next.js"). Clones the publication starter repo or uses `starters/blank`. |
