...
description: Deploy an installed clam-cms consumer project to the user's Cloudflare account and return the public URL plus MCP URL. Use after the install Skill has created a standalone project and the user wants the service online.
when_to_invoke: |
...
- Don't deploy with `CLAM_ALLOW_STUB_OAUTH=1`.
