...
/**
 * `clam-mantle validate` — Loop 1 of the SDK authoring contract
...
function printHelp(): void {
  stdout.write(`clam-mantle validate — Loop 1 static manifest validation

Usage: clam-mantle validate [options]
