...
Use [`@aotterclam/clam-cms-cloudflare`](../clam-cms-cloudflare/README.md). Cloudflare Workers gives you D1 + KV + ASSETS in one place at zero cost (no credit card needed for the v0.1.0 starter set).
