...
export const CLAM_CMS_PACKAGE = "@aotterclam/clam-cms";
export const CLAM_CMS_VERSION = __CLAM_CMS_VERSION__;
export const AOTTER_CLAM_HOME_URL = "https://aotterclam.com";
export const CLAM_CMS_GITHUB_URL = "https://github.com/AotterClam/clam-cms";
...
export function AdminAttribution(): React.ReactElement {
  return (
    ...
    >
      ...
      <span aria-label={`version ${CLAM_CMS_VERSION}`}>v{CLAM_CMS_VERSION}</span>
    </div>
  );
}
