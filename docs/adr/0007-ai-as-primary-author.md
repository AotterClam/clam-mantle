...
#### Loop 2 — Test harness (`@aotter/mantle-core/testing`)
...
```ts
import { createTestDispatcher } from "@aotter/mantle-core/testing";
...
- `@aotter/mantle-core/testing` test harness module
...
These are exported from `@aotter/mantle-core` for the coder to
