...
- `/admin/auth/github` + `/admin/auth/github/callback` — ~110 LOC of upstream OAuth client code in `clam-cms-cloudflare/src/oauth/githubOAuth.ts`
...
- `clam-cms-cloudflare/src/oauth/githubOAuth.ts` (entire)
- `clam-cms-cloudflare/src/bindings/D1UserRepository.ts` (entire — Better Auth owns)
- `clam-cms-cloudflare/src/bindings/D1SessionRepository.ts` (entire)
- `clam-cms-cloudflare/src/bindings/D1StaffRepository.ts` (entire)
- `clam-cms-runtime/src/domain/port/UserRepository.ts` (Better Auth API replaces)
- `clam-cms-runtime/src/domain/port/SessionRepository.ts` (Better Auth API replaces)
- `clam-cms-runtime/src/domain/port/StaffRepository.ts` (no separate staff layer)
- `clam-cms-runtime/src/runtime.ts` `users` / `sessions` / `staff` ports
